Feature: Add a Wish Validator
  ...
  Scenario: Bad request when try to add more products than allowed
    Given A user Post 20 wishes to endpoint '/api/v1/f3882d8d-199c-46d2-8944-936f13645515/wishlist'
    When perform a POST to endpoint "/api/v1/f3882d8d-199c-46d2-8944-936f13645515/wishlist" adding a new wish
